...
<?php 
	...
	if($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		$database = new Database('mysql14.000webhost.com', 'a7581166_geofoto', 'AbCd1234', 'a7581166_book');
		
		$title = mysql_real_escape_string($_POST['title']);
		$author = mysql_real_escape_string($_POST['author']);
		$description = mysql_real_escape_string($_POST['description']);
		
		$database->insert($title, $author, $description);
		
		echo "<div class=\"ui icon green message\">
  				<i class=\"beer icon\"></i>
  				<div class=\"content\">
    			<div class=\"header\">Το βιβλίο προστέθηκε στην λίστα σου!</div>
    			<p>Μπράβο, πιες μια μπύρα στην υγεία του θείου Τσαρλς και συνέχισε να προσθέτεις βιβλία</p>
  				</div>
			 </div>";
